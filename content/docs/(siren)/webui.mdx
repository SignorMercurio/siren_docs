...
import { Users, Terminal, Brain, Files, FolderTree, Lock, Plug, Key } from 'lucide-react';
...
<Cards>
  ...
  <Card title="Artifacts" icon={<FolderTree />}>服务端取证文件浏览，支持 Markdown/HTML 预览、二进制识别、文件下载</Card>
</Cards>
...
- **HTML 报告预览**：`.html` 文件直接在沙箱 iframe 内渲染，可正常加载同目录下的 CSS、JS、字体、图片等相对资源，并支持报告内下载链接，适合查看 [Agentic IR](/air) 等生成的报告
