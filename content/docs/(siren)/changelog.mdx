...
- **Artifacts Markdown 报告接入 Dossier**：`.md` / `.markdown` 报告可从 Artifacts 打开到 Dossier，直接进入编辑流程
...
- 使用 Dossier 前需要先部署 Dossier 编辑器文件，默认目录为 `/opt/siren/dossier`，自定义路径请参考 WebUI 文档
