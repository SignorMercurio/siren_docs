...
## v2.13.0 <DateTag>2026-07-03</DateTag>
...
- **Recon 收敛为快速、确定性的采集器**：移除矿工、Webshell、Rootkit 符号、可疑命令、时间戳篡改等黑名单/签名判定（含独立的 Webshell 模块与 `recon.webshell` 开关），是否可疑改由 AIR 结合上下文判断，采集更快、噪声更低
